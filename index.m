...
% This code here is what was later used in GUI To train the neural network EMNIST 
% dataset was used, which can be downloaded from here <https://www.kaggle.com/crawford/emnist 
...
imagePath = fullfile('testImages','images.png');
